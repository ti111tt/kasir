            ...
            <nav class="navbar bg-secondary navbar-dark">
              ...
              />{{ $logo->nama_web }}
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ url('home/input_kode_barang') }}" class="nav-item nav-link">
                        <i class="fa fa-th me-2"></i>input barang 
                    </a>
                    <a href="{{ url('home/barcode') }}" class="nav-item nav-link">
                        <i class="fa fa-th me-2"></i>make barcode
                    </a>
